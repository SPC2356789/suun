...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('calendar/fonts/icomoon/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('calendar/fullcalendar/packages/core/main.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('calendar/fullcalendar/packages/daygrid/main.css')); ?>">


    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('calendar/css/bootstrap.min.css')); ?>">

    <!-- Style -->
    <link rel="stylesheet" href="<?php echo e(asset('calendar/css/style.css')); ?>">

    <script src="<?php echo e(asset('calendar/js/popper.min.js')); ?>"></script>
    <script src="<?php echo e(asset('main/js/main.js')); ?>"></script>
    
    <link rel="stylesheet" href="<?php echo e(asset('calendar/self_element.css')); ?>">

    

    <script src="<?php echo e(asset('calendar/fullcalendar/packages/core/main.js')); ?>"></script>
    <script src="<?php echo e(asset('calendar/fullcalendar/packages/interaction/main.js')); ?>"></script>
    <script src="<?php echo e(asset('calendar/fullcalendar/packages/daygrid/main.js')); ?>"></script>
...
<div class="container-xxl py-1">
    <div class="container">
        ...
        <div class="row g-4 portfolio-container wow fadeInUp justify-content-center" data-wow-delay="0.5s">
            <?php $__currentLoopData = $pPost; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-lg-4 col-md-6 portfolio-item ">
                    <div class=" rounded overflow-hidden post_detail" data-post="<?php echo e($Post['id']); ?>">
                        <img class="img-fluid " src="<?php echo e(asset('storage/'.$Post['image_path'])); ?>" alt="">

                    </div>
                    <div class="pt-3">
                        <p class="text-primary mb-0"><?php echo e($Post['title']); ?></p>
                        <hr class="text-primary w-25 my-2">
                        <h5 class="lh-base"><?php echo e($Post['subtitle']); ?></h5>
                    </div>
                </div>
            ...
            <div class="col-12 text-center ">
                ...
                <div class="">
                    ...
                    <a class="btn btn-square btn-outline-light btn-social" target="_blank" href="https://Lin.ee/r75pCdi"><img
                            src="<?php echo e(asset("storage")); ?>/LINE_pic.png"
...
<script>
    $(function () {
        var holidayAry = <?php echo json_encode($holidayAry); ?>;//休假日宣告
        var count_time = <?php echo json_encode($count_time); ?>;

        $(document).on('click', '.post_detail', function (e) {
            var post_id = $(this).data('post');
            // console.log(post_id)
            var pPost_json = <?php echo json_encode($pPost); ?>;
            var post = pPost_json[post_id];
            var h =
                `<img class="post_image" src="<?php echo e(asset("storage")); ?>/` + post['image_path'] + `" alt="Custom Icon"><div class="post_content">` + post['content'] + `</div>`;
            // console.log(post)
            Swal.fire({
                width: 480,
                customClass: {
        ...
        $(document).ready(function () {
            ...
            $('.fc-dayGrid-view').prepend(<?php echo json_encode($note[0]); ?>);//標頭備註
    ...
    function updateCalendar(holidayAry, count_time) {
        ...
        var ptime_json = <?php echo json_encode($pReserve); ?>;
        ...
        weekElements.each(function (index, weekElement) {
            ...
            <div class="detail_data detail detail-${index + 1}">
              <?php $__currentLoopData = $ptime; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style=" background-color: <?php echo e(($time['id'] % 2 !== 0) ? '#D1D7DF56' : '#9abcd256'); ?>">
                    <table>
                        <a style="width: 85px" class="time_title fc-day-grid-event fc-h-event fc-event fc-start fc-end fc-draggable fc-resizable">
                            <div class="fc-content">
                                <span class=""><?php echo e($time['time']); ?></span>
                            </div>
                ...
                var time = "<?php echo e(str_replace(['-', ':'], '', $time['time'])); ?>";//加雙引號0才不會被吃掉
...
<?php /**PATH /home/1198728.cloudwaysapps.com/chayafrjfc/public_html/resources/views/font/Home.blade.php ENDPATH**/ ?>